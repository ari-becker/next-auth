 ...
 *
 * ```bash npm2yarn2pnpm
 * npm install next-auth @drizzle-orm @next-auth/drizzle-orm-adapter
 * npm install drizzle-kit --save-dev
 * ```
 *
 * @module @next-auth/drizzle-orm-adapter
 */
 ...
 * import { DrizzleORMAdapter } from "@next-auth/drizzle-orm-adapter"
...
export function PrismaAdapter(db: DrizzleDatabase): Adapter {
    return {
